    ...
    public static int entero() {
        ...
        do {
            try {
                ...
                System.out.print("ERROR: Se esperaba un entero. Inténtalo de nuevo: ");
            }
        } while (!leido);
        return valor;
    }
    ...
    public static long enteroLargo() {
        ...
        do {
            try {
                ...
                System.out.print("ERROR: Se esperaba un entero largo. Inténtalo de nuevo: ");
            }
        } while (!leido);
        return valor;
    }
    ...
    public static float real() {
        ...
        do {
            try {
                ...
                System.out.print("ERROR: Se esperaba un real. Inténtalo de nuevo: ");
            }
        } while (!leido);
        return valor;
    }
    ...
    public static double realDoble() {
        ...
        do {
            try {
                ...
                System.out.print("ERROR: Se esperaba un real de doble precisión. Inténtalo de nuevo: ");
            }
        } while (!leido);
        return valor;
    }
    ...
    public static char caracter() {
        ...
        do {
            ...
            if (valor.length() == 1) {
                ...
                System.out.print("ERROR: Se esperaba un caracter. Inténtalo de nuevo: ");
            }
        } while (!leido);
